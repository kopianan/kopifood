...
class __$$_NotFoundCopyWithImpl<$Res>
    extends _$FailuresCopyWithImpl<$Res, _$_NotFound>
...
abstract class _NotFound implements Failures {
...
class _$_GeneralError implements _GeneralError {
  ...
  @override
  String toString() {
    return 'Failures.generalError(message: $message)';
  }
...
abstract class _GeneralError implements Failures {
  factory _GeneralError(final String message) = _$_GeneralError;
